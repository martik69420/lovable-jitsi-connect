        ...
        {isLoading ? (
          ...
          filteredContacts.map((contact) => (
            <button
              key={contact.id}
              className={cn(
                'flex items-center gap-3 p-3 hover:bg-muted/50 w-full text-left border-b relative transition-colors',
            ...
            >
              ...
              {(contact.unreadCount || 0) > 0 && (
                <Badge variant="destructive" className="absolute top-3 right-3 h-5 min-w-5 flex items-center justify-center text-xs px-1.5">
                  {contact.unreadCount}
                </Badge>
              )}
            </button>
